...
import (
	...
	"github.com/tektoncd/experimental/jenkins/pkg/reconciler"
...
const controllerName = "jenkins-controller"
...
func newController(ctx context.Context, cmw configmap.Watcher) *controller.Impl {
	...
	runInformer.Get(ctx).Informer().AddEventHandler(cache.FilteringResourceEventHandler{
		FilterFunc: tkncontroller.FilterRunRef("jenkins.tekton.dev/v0", "JenkinsJob"),
