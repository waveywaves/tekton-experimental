...
import (
	...
	"github.com/tektoncd/experimental/task-loops/pkg/apis/cdfevents_pipelinerun"
	taskloopv1alpha1 "github.com/tektoncd/experimental/task-loops/pkg/apis/cdfevents_pipelinerun/v1alpha1"
...
func NewController(namespace string) func(context.Context, configmap.Watcher) *controller.Impl {
	return func(ctx context.Context, cmw configmap.Watcher) *controller.Impl {
		...
		runInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
			FilterFunc: pipelinecontroller.FilterRunRef(taskloopv1alpha1.SchemeGroupVersion.String(), cdfevents_pipelinerun.CDFEventsPipelineRunControllerName),
		...
		taskRunInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
			FilterFunc: pipelinecontroller.FilterOwnerRunRef(runInformer.Lister(), taskloopv1alpha1.SchemeGroupVersion.String(), cdfevents_pipelinerun.CDFEventsPipelineRunControllerName),
